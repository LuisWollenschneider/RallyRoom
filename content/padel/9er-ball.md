...
diagram:
  ...
  zones:
    - { id: e9, x: 0.351, y: 0.002, width: 0.272, height: 0.037, label: Balllager, color: '#f5e642' }
    - { id: e11, x: 0.349, y: 0.969, width: 0.272, height: 0.037, label: Balllager, color: '#f5e642' }
diagram2:
  players:
    - { id: e12, team: A, x: 0.237, y: 0.133, label: A1 }
    - { id: e13, team: A, x: 0.734, y: 0.132, label: A2 }
