...
diagram:
  players:
    - { id: e1, team: A, x: 0.508, y: 0.062, label: P }
...
Die restlichen Spieler (S) + (W_) befinden sich auf der anderen Seite.

## Ablauf
Spieler (S) hat immer Angabe. Für die Angabe muss (S) hinter der Grundlinie stehen.
- Verliert er den Punkt, stellt er sich hinten an, (W1) ist als nächstes dran und wird zu (S).
- Gewinnt er den Punkt, hat er erneut Angabe.
  - Sobald 3 Punkte in Folge gewonnen wurden, wird er der neue Platzkönig (P), wechselt die Seite, und der vorherige Platzkönig stellt sich in die Warteschlange.

Punkte kann nur der Platzkönig machen. Jeder Punkt zählt 1p.
...
## Trainer Hinweise
Es ist ratsam vor dem Spiel alle Bälle auf die Seite von (S) + (W) zu bringen. 
Von der Seite wird immer aufgeschlagen, wodurch viele Bälle verbraucht werden.
